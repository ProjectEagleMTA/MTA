...
local Discord_DIR = "vendor/discordgsdk/lib"
local SDK_name = "discord_game_sdk.dll"
local discord_path = Discord_DIR.."/x86/"..SDK_name
...
newaction {
	...
	execute = function()
		...
		elseif os.host() == "macosx" then
			...
			local success = http.download_print_errors(NET_PATH_X64_LINUX, BIN_DIR.."/server/x64/net.so")
