...
#ifdef MTA_CLIENT
#define MTA_DM_FULL_STRING "META Client"
#else
#define MTA_DM_FULL_STRING "META Server"
#endif
...
// Implement compile types
    ...
    #define MTA_DM_BUILDTAG_SHORT   MTA_DM_VERSIONSTRING "-" MTA_DM_BUILDTYPE "-" QUOTE_DEFINE("META-WORK")
    #define MTA_DM_BUILDTAG_LONG    MTA_DM_VERSIONSTRING "-" MTA_DM_BUILDTYPE "-" QUOTE_DEFINE("META-WORK")
...
#define _ASE_VERSION QUOTE_DEFINE(MTASA_VERSION_MAJOR) "." QUOTE_DEFINE(MTASA_VERSION_MINOR) "." QUOTE_DEFINE(MTASA_VERSION_MAINTENANCE) "NRPClient"
