...
CGameSA::CGameSA()
{
    ...
    m_pPools->SetPoolCapacity(BUILDING_POOL, 40000);
    m_pPools->SetPoolCapacity(PED_POOL, 140);
    m_pPools->SetPoolCapacity(TASK_POOL, 500);
    m_pPools->SetPoolCapacity(OBJECT_POOL, MAX_OBJECTS);
    m_pPools->SetPoolCapacity(DUMMY_POOL, 300);
    m_pPools->SetPoolCapacity(EVENT_POOL, 100);
    m_pPools->SetPoolCapacity(COL_MODEL_POOL, 6000);
    m_pPools->SetPoolCapacity(ENV_MAP_MATERIAL_POOL, 4096);
    m_pPools->SetPoolCapacity(ENV_MAP_ATOMIC_POOL, 4000);
    m_pPools->SetPoolCapacity(SPEC_MAP_MATERIAL_POOL, 16000);
    m_pPools->SetPoolCapacity(ENTRY_INFO_NODE_POOL, MAX_ENTRY_INFO_NODES);
    m_pPools->SetPoolCapacity(POINTER_SINGLE_LINK_POOL, 85000);
    m_pPools->SetPoolCapacity(POINTER_DOUBLE_LINK_POOL, MAX_POINTER_DOUBLE_LINKS);
