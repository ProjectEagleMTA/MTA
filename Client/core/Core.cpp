...
CGraphics*       g_pGraphics = nullptr;
CConnectManager* g_pConnectManager = nullptr;
CLocalization*   g_pLocalization = nullptr;
...
CORE_API int InitializeCore()
{
    ...
    g_pCore = new CCore();
    //startParams.applicationLibBaseAddress = (void*)GetModuleHandle(NULL);
    //startParams.pluginHandle = g_hModule;
    //ag_LimitAdjuster.StartLimitAdjuster(&startParams);
    return 0;
}
