...
bool CConnectManager::Connect(const char* szHost, unsigned short usPort, const char* szNick, const char* szPassword, bool bNotifyServerBrowser, const char* szSecret)
{
    ...
    //} integrityCheckList_mta[] = {
    //    {"8EB9167D68897A89B3EFE47162C1574A", "bass.dll"},
    //    {"285A668CB793F5A5CA134DE9682A6064", "bass_aac.dll"},
    //    {"07C11F7D8058F350ADF6FC9AB81B38AC", "bass_ac3.dll"},
    //    {"D8CCB4B8235F31A3C73485FDE18B0187", "bass_fx.dll"},
    //    {"64C96631887874F7ED9D8881FC016846", "bassflac.dll"},
    //    {"4D34014DB481244EABA366B827DDD1B5", "bassmidi.dll"},
    //    {"5DEEC10A943E352EF7E0223327E8B48C", "bassmix.dll"},
    //    {"B04050AD912FB7E03F529F2C3F7D991D", "bassopus.dll"},
    //    {"0F1B2FC6C0C703A43A24DC05352E7ADA", "basswebm.dll"},
    //    {"893113C6C49DC1E1EF288310E68DB306", "basswma.dll"},
    //    {"9C12FF87F03610EBD24D35A85D0A14C3", "tags.dll"},
    ...
    //    {"3B4647BCB9FEB591C2C05D1A606ED988", "d3dcompiler_47.dll"},
    //    {"F137D5BE2D8E76597B3F269B73DBB6A6", "XInput9_1_0_mta.dll"},
    //    {"C48B6A57EC8F25C2F5C1BC8B853CB0C4", "netc.dll"},
    //    {"341851E8398E6A45E052C72EB93E9A69", "mtasa.dll"}
    //};

    //for (int i = 0; i < NUMELMS(integrityCheckList_mta); i++)
    //{
    //    SString strMd5 = CMD5Hasher::CalculateHexString(PathJoin("mta", integrityCheckList_mta[i].szFilename));
    //    if (!strMd5.CompareI(integrityCheckList_mta[i].szMd5))
    //    {
    //        CCore::GetSingleton().ShowMessageBox(_("Disconnected"), _("Error reading game files. Reinstall the game!"), MB_BUTTON_OK | MB_ICON_ERROR);
    //        CCore::GetSingleton().m_pLocalGUI->GetMainMenu()->SetVisibleCustomButtons(true);
    //        return false;
    //    }
    //}
    ...
    //    const char* szMd5;
    //    const char* szFilename;
    //} integrityCheckList_mods[] = {
    //    {"CE6D31F41FF556BEEB3276DFF2970CF1", "client.dll"},
    //    {"C8F09A19D22DD3AF2AB26380F8FB5EF2", "lua5.1c.dll"},                              
    //    {"4ECF980300A88FD6D477325D11EDAA32", "pcre3.dll"}
    //};

    //for (int i = 0; i < NUMELMS(integrityCheckList_mods); i++)
    //{
    //    SString strMd5 = CMD5Hasher::CalculateHexString(PathJoin("mods\\deathmatch", integrityCheckList_mods[i].szFilename));
    //    if (!strMd5.CompareI(integrityCheckList_mods[i].szMd5))
    //    {
    //        CCore::GetSingleton().ShowMessageBox(_("Disconnected"), _("Error reading game files. Reinstall the game!"), MB_BUTTON_OK | MB_ICON_ERROR, m_pOnCancelClick);
    //        CCore::GetSingleton().m_pLocalGUI->GetMainMenu()->SetVisibleCustomButtons(true);
    //        return false;
    //    }
    //}
