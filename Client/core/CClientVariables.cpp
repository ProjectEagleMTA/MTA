...
#define _S(__x) std::string(__x)
    ...
    // DEFAULT("host", _S("s1.meta-gta.com.ua"));                                    // hostname
    DEFAULT("host", _S("192.168.0.108"));                                    // hostname
    DEFAULT("port", 22003);                                              // port
    DEFAULT("password", _S(""));                                         // password
    DEFAULT("qc_host", _S("127.0.0.1"));    
    // DEFAULT("qc_host", _S("s1.meta-gta.com.ua"));    
    // DEFAULT("qc_host", _S("192.168.0.109"));                                 // quick connect hostname
    ...
    DEFAULT("fps_limit", 32767);                                         // frame limiter
    ...
    DEFAULT("mapalpha", 255);                                                         // map alpha
    ...
    DEFAULT("mute_master_when_minimized", 1);                                         // 0-off 1-on
    ...
    DEFAULT("fov", 100);                                                              // Camera field of view
...
#if 0
    DEFAULT ( "streaming_memory",           512 );                           // Streaming memory
#endif
}
