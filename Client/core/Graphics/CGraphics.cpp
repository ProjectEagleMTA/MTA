...
void CGraphics::OnDeviceCreate(IDirect3DDevice9* pDevice)
{
    ...
    m_ProgressSpinnerTexture =
        GetRenderItemManager()->CreateTexture(CalcMTASAPath("MTA\\cgui\\images\\transferset\\busy_spinner.png"), NULL, false, -1, -1, RFORMAT_DXT3, TADDRESS_CLAMP);
    ...
    do
    {
        ...
        // Draw progress graphics on backbuffer surface
        {
            ...
            if (m_ProgressSpinnerTexture)
            {
                ...
                const DWORD dwSpinnerColor = 0xFFFFFFFF;
                ...
                DrawTexture(m_ProgressSpinnerTexture, uiSpinnerPosX, uiViewportHeight - 205, fScaleX, 1, 0, 0, 0, dwSpinnerColor,
