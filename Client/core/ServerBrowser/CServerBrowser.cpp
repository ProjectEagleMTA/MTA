...
CServerBrowser::CServerBrowser()
{
    ...
    float fMaxLeft = pManager->CGUI_GetMaxTextExtent("default-normal", _("Refresh"), _("Connect"), _("Server information"));
...

    {
        ...
        struct
        {
            ...
            {20, iBase + iGap * 1, 26, 26, "cgui\\images\\serverbrowser\\connect.png"},
            {20, iBase + iGap * 2, 26, 26, "cgui\\images\\serverbrowser\\info.png"},
        ...
        struct
        {
            ...
            {20, iBase + iGap * 1, _("Connect")},
            {20, iBase + iGap * 2, _("Server information")},
