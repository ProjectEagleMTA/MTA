...
public:
    ...
    void SetVisibleMainMenu(bool bVisible);
    void IsVisibleMainMenu();
    void CreateProgressBarImage(bool bVisible);
    void CreateProgressBar(bool bVisible, int szNumber);
    ...
    CGUIStaticImage* m_pProgressBarImage;
    CGUIStaticImage* m_pProgressBar;
