...
public:
    ...
    static bool                                            setLoadingScreenVisible(bool bVisible);
    static int                                             takeScreenShot(bool bScreen);
    static int                                             exitGame(lua_State* luaVM);
    static void                                            settingsGame(bool bVisible);
    static int                                             GetLaunchData(lua_State* luaVM);
    static void                                            IsLoadingScreenVisible(lua_State* luaVM);
    static int                                             RemoveModelFromMemory(lua_State* luaVM);
    static int                                             SetClientDrawDistance(lua_State* luaVM);
    static int                                             GetClientMemoryInfo(lua_State* luaVM);
    static int                                             GetClientDrawDistance(lua_State* luaVM);
