    ...
    : ClassInit(this), CClientStreamElement(pManager->GetVehicleStreamer(), ID)
{
    ...
    if ((m_usModel < 400 || m_usModel > 611) && (m_usModel < 6283 || m_usModel > 6525) && (m_usModel < 6526 || m_usModel > 6704) && (m_usModel < 17306 || m_usModel > 17628))
...
void CClientVehicle::SetModelBlocking(unsigned short usModel, unsigned char ucVariant, unsigned char ucVariant2)
{
    ...
    if (m_usModel != usModel)
    {
        ...
        if (IsLocalEntity() || !(usModel < 400 || usModel > 611) && (usModel < 6283 || usModel > 6525) && (usModel < 6526 || usModel > 6704) && (usModel < 17306 || usModel > 17628))
        {
            ushort usHandlingModelID = usModel;
            if ((usHandlingModelID < 400 || usHandlingModelID > 611) && (usHandlingModelID < 6283 || usHandlingModelID > 6525) && (usHandlingModelID < 6526 || usHandlingModelID > 6704) && (usHandlingModelID < 17306 || usHandlingModelID > 17628))
                usHandlingModelID = m_pModelInfo->GetParentID();
