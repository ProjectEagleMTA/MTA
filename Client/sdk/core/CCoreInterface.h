...
public:
    ...
    virtual void SetVisibleMainMenu(bool bVisible) = 0;
    virtual void IsVisibleMainMenu() = 0;
    virtual void CreateProgressBarImage(bool bVisible) = 0;
    virtual void CreateProgressBar(bool bVisible, int szNumber) = 0;
